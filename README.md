...
You don't need any installation, just click on "[La Chouette Agence](https://haltay.github.io/P4_01.02.21/)" and it will be open in your browser.
...
## Tasks
    ...
    - use of HTML and CSS
    - Responsive website
    - SEO improvement from 78 to 98 (lighthouse)
    - Accessibility improvement from 84 to 97 (lightouse), and no warning with wave
